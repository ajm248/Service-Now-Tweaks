...
function OneTaskResult(){
    return (jQuery('#group_8c58a5aa0a0a0b07008047e8ef0fe07d:contains("1 match")').length && jQuery('#group_8c59970e0a0a0b07013feb5e0d09c952:contains("No match")').length && jQuery('#group_2b77ce594bd6c0d901b8fbe25ceff671:contains("No match")').length)
}
...
function OneKnowledgeResult(){
  return jQuery('.kb_header_title_row').parent().find('a.kblinked').length == 1
}
